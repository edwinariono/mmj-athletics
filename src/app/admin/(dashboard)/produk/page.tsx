...
export default function ProductManagementPage() {
  ...
  async function loadProducts() {
    ...
    const { data } = await supabase
      .from("products")
      .select("id, name, brand, status, images, categories(name)")
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-bg border border-border clip-corner-sm flex items-center justify-center shrink-0 relative overflow-hidden">
                            {hasImage ? (
                              <Image
